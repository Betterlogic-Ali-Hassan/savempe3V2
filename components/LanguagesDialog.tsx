...
const LanguagesDialog = () => {
  return (
    <Dialog>
      <DialogTrigger className='cursor-pointer hover:text-[#166aea]'>
        <svg
        ...
        >
          <path
            d='M437.02,74.98C388.668,26.629,324.38,0,256.001,0S123.333,26.629,74.982,74.98S0,187.62,0,256.001
      ...
      >
        <ul className='columns-3'>
          {languages.map((language, i) => (
            <li
              key={i}
              className='min-w-[100px] mb-6 mt-1 cursor-pointer text-[20px] hover:text-[#166aea]'
            >
              {language}
            </li>
          ))}
        </ul>
        <DialogClose className='absolute right-10 top-10 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
